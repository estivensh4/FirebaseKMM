...
fun <T> encode(
    strategy: SerializationStrategy<T>, value: T, shouldEncodeElementDefault: Boolean
): Any? = FirebaseEncoder(shouldEncodeElementDefault).apply {
...
class FirebaseEncoder(val shouldEncodeElementDefault: Boolean) : Encoder {
    ...
    override fun beginStructure(descriptor: SerialDescriptor): CompositeEncoder {
        ...
        if (polymorphicDiscriminator != null) {
            encoder.encodePolymorphicClassDiscriminator(
                polymorphicDiscriminator!!, descriptor.serialName
            )
...
open class FirebaseCompositeEncoder constructor(
    ...
    ) = set(descriptor, index, value?.let {
        FirebaseEncoder(shouldEncodeElementDefault).apply {
    ...
    override fun <T> encodeSerializableElement(
        ...
        descriptor, index, FirebaseEncoder(shouldEncodeElementDefault).apply {
            encodeSerializableValue(serializer, value)
        }.value
    )
